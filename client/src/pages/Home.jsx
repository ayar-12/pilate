...
function Home() {
  ...
  const playAnims = !hasSeenIntro && !reduceMotion; // first visit only
  ...
  useEffect(() => {
    ...
    const i = setInterval(() => setCurrentIndex(prev => (prev + 1) % latestCourses.length), 3000);
  ...
  // Reusable blog-style animation props
  const A = {
                  ...
                  <motion.div {...A}>
                    ...
                    >
                      ...
                      <div style={{ position: 'absolute', bottom: 20, left: 20, color: '#fff', fontSize: '15px',
                        fontStyle:'bold', fontFamily: 'Poppins' }}>
                        <p style={{ margin: 0 }}>
