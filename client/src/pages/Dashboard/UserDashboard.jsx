...
// Generic card wrapper that fills its grid cell
...
const FitnessDashboard = () => {
  ...
  const fetchSteps = async () => {
    try {
      ...
      setStepData({
        ...
        message:
          latest > 5000
            ? "You're walking more than you usually do."
  ...
  useEffect(() => {
    // restore cached stepData for <24h if present
  ...
  return (
    <Box sx={{ minHeight: "100vh", p: { xs: 1.5, sm: 2, md: 4 } }}>
      ...
      {/* ROW 1 — profile, food, steps, water */}
      <Grid container spacing={{ xs: 2, sm: 2, md: 3 }} alignItems="stretch">
        {/* Profile */}
        <Grid item xs={12} sm={6} md={6} lg={3}>
          <DashboardWidget title="User Profile" sx={{ background: "#FFFCFB" , width: { xs: 400, sm: 300 }}}>
...
>
              ...
              <DialogActions>
                ...
                <Button onClick={submitSteps} disabled={!stepValue}>
                  Save
                </Button>
              </DialogActions>
            </Dialog>
